...
#' ## Metadata
ggplot(sa, aes(age)) + geom_bar() + theme_cowplot() + labs(y = 'Samples')
ggplot(sa, aes(Cohort)) + geom_bar() + theme_cowplot() + labs(y = 'Samples')
ggplot(sa, aes(sex)) + geom_bar() + theme_cowplot() + labs(y = 'Samples')
ggplot(sa, aes(ethnicity)) + geom_bar() + theme_cowplot() + labs(y = 'Samples') +
